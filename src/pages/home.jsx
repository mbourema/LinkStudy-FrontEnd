...
export default function Home() {
    ...
    return (
      <div>
        <div className="flex flex-row">
          ...
          <img className="size-70 w-auto mt-10 mr-32" src="../images/work_together.jpg" alt="reseau de travail"></img>     
        </div>
        <div className="flex flex-row">
          <img className="size-70 w-auto ml-24" src="../images/Levels.png" alt="entraide"></img> 
          <p className="text-2xl font-bold ml-20 mt-12">Look for people studying in your field, at a more or less advanced level than yours, at the place of work and time slot that suits you <svg xmlns="http://www.w3.org/2000/svg"
           width="36" height="36" fill="purple" className="bi bi-highlighter inline-flex mr-4" viewBox="0 0 16 16"> <path fill-rule="evenodd"
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/>
          ...
          <img className="size-70 w-auto mr-24" src="../images/messaging.png" alt="reseau de travail"></img>     
        </div>
      </div>    
    );
  }
