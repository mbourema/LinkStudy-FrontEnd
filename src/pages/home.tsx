...
export default function Home() {
    ...
    return (
      <div>
        <div className="flex md:flex-row flex-col">
          ...
          <img className="md:size-70 md:w-auto h-40 w-65 mt-10 ml-20 mr-32" src="../images/work_together.jpg" alt="reseau de travail"></img>     
        </div>
        <div className="flex md:flex-row flex-col-reverse">
          <img className="md:size-80 md:w-auto h-50 w-65 ml-44" src="../images/Levels.png" alt="entraide"></img> 
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/>
          ...
          <img className="md:size-80 md:w-auto h-50 w-75 mr-24" src="../images/messaging.png" alt="reseau de travail"></img>     
        </div>
      </div>    
    );
  }
