    ...
    <nav className={`bg-secondary fixed w-full h-20 top-0 ${isOpen ? "z-10 pointer-events-auto" : "z-1 pointer-events-none"}`}>
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center">
            ...
            <input type="text" className="flex flex-col p-2 justify-start text-lg text-black border-2 rounded-3xl focus:outline-none focus:ring-black hover:scale-110 transition-transform duration-200 shadow-lg pointer-events-auto" placeholder="Entrez une adresse..."/>
            <button type="button"> 
            <svg className="hover:scale-120 transition-transform duration-200 pointer-events-auto" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 50 50">
        ...
        <button
          className="xl:hidden text-white focus:outline-none relative pointer-events-auto"
